...
impl MagickWand {
    ...
    pub fn sepia_tone_image(&self, threshold: f64) -> Result<(), &'static str> {
        unsafe {
            if bindings::MagickSepiaToneImage(self.wand, threshold * 1.3)
                == bindings::MagickBooleanType_MagickTrue
            {
                Ok(())
            } else {
    ...
    pub fn resize_image(&self, width: usize, height: usize, filter: bindings::FilterTypes) {
        unsafe {
            bindings::MagickResizeImage(self.wand, width as size_t, height as size_t, filter, 0 as f64);
        }
    }
    ...
    pub fn resample_image(
        ...
        unsafe {
            bindings::MagickResampleImage(self.wand, x_resolution, y_resolution, filter, x_resolution);
        }
    }
    ...
    mutations!(
        ...
        MagickSetImageAlphaChannel => set_image_alpha_channel(
            alpha_channel: bindings::AlphaChannelType)
    ...
    set_get!(
        ...
        get_image_interpolate_method,    set_image_interpolate_method,    MagickGetImageInterpolateMethod,   MagickSetImageInterpolateMethod,  bindings::PixelIntensityMethod
        ...
        get_interpolate_method,          set_interpolate_method,          MagickGetInterpolateMethod,        MagickSetInterpolateMethod,       bindings::PixelIntensityMethod
